...
Parser.prototype.__push = function(line) {
  var field, i, j, len, lineAsColumns, rawBuf, row, lineHasError;
  ...
  if (line.length === 1 && line[0] === '') {
    ...
    if (this.options.relax_column_count) {
      ...
      if(this.options.skipToNextLineOnError) {
         if (!lineHasError) {
             lineHasError = true;
             console.log("Number of columns on line " + this.lines + " does not match header");
         } else {
...
Parser.prototype.__write = function(chars, end, callback) {
  var areNextCharsDelimiter, areNextCharsRowDelimiters, auto_parse, char, escapeIsQuote, i, isDelimiter, isEscape, isNextCharAComment, isQuote, isRowDelimiter, is_float, is_int, l, ltrim, nextCharPos, ref, remainingBuffer, results, rowDelimiter, rowDelimiterLength, rtrim, wasCommenting, lineHasError;
